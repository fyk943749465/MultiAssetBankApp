...
import {
  ...
  Transfer
} from "../generated/NFTTemplate/NFTTemplate"
...
export function createDefaultRoyaltyUpdatedEvent(
  receiver: Address,
  feeNumerator: BigInt
): DefaultRoyaltyUpdated {
  let defaultRoyaltyUpdatedEvent =
    changetype<DefaultRoyaltyUpdated>(newMockEvent())

  defaultRoyaltyUpdatedEvent.parameters = new Array()

  defaultRoyaltyUpdatedEvent.parameters.push(
  ...
  return defaultRoyaltyUpdatedEvent
}
