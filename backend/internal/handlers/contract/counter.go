...
// @Tags         contract
// @Produce      json
// @Success      200 {object} handlers.CounterValueResp
// @Failure      503 {object} handlers.ErrorJSON "contract or RPC not configured"
// @Failure      502 {object} handlers.ErrorJSON "RPC / contract call error"
// @Router       /api/contract/counter/value [get]
func CounterValue(h *handlers.Handlers) gin.HandlerFunc {
...
// @Tags         contract
// @Produce      json
// @Success      200 {object} handlers.CounterIncrementResp
// @Failure      503 {object} handlers.ErrorJSON "contract, RPC, or private key not configured"
// @Failure      502 {object} handlers.ErrorJSON "transaction send error"
// @Failure      500 {object} handlers.ErrorJSON
// @Router       /api/contract/counter/count [post]
func CounterIncrement(h *handlers.Handlers) gin.HandlerFunc {
	return func(c *gin.Context) {
		if h.Counter == nil {
			c.JSON(http.StatusServiceUnavailable, gin.H{"error": "counter contract not configured (set COUNTER_CONTRACT_ADDRESS)"})
			return
